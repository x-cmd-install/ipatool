...
[![x-cmd/install — ipatool Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/ipatool.svg?lang=zh)](https://x-cmd.com/install/ipatool)
...
- **Star**: 11,399 · **Fork**: 948 · **开放 issue**: 366 · **贡献者**: 36

## 累计统计

- **发布数**: 38 · **已合并 PR**: 153 · **开放 PR**: 0 · **已关闭 issue**: 350 · **开放 issue**: 16 · **提交数**: 247
...
_数据快照: `data/card/260926.yml` · 2026-09-26T05:58:45Z._
